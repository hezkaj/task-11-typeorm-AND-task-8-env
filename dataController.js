...
exports.updateUser = exports.deleteUser = exports.getOneUser = exports.getAllUsers = exports.createUser = void 0;
...
function createUser(name, age) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dataSource.createQueryBuilder()
                        .insert()
                        .into(users_1.Users)
                        .values([
                        { name: name, age: age },
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, 'Successfully created'];
            }
        });
    });
}
